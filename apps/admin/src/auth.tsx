      ...
      >
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(255,255,255,0.12)', borderRadius: 999, padding: '8px 16px', fontWeight: 700, letterSpacing: 0.5 }}>
            <Building2 size={18} color={ui.brand} /> EUROHOUSE ADMIN
          </div>
          <h1 style={{ fontSize: 44, lineHeight: 1.1, margin: '24px 0 16px', fontWeight: 800 }}>Hệ thống quản trị vận hành</h1>
          <p style={{ color: 'rgba(255,255,255,0.82)', fontSize: 17, lineHeight: 1.7, maxWidth: 440 }}>
            Theo dõi đơn hàng từ xưởng, nhà phân phối và toàn bộ hoạt động Eurohouse trên một màn hình duy nhất.
          </p>
        </div>
      </section>
        ...
        <form onSubmit={handleLogin} style={{ width: '100%', maxWidth: 400, display: 'grid', gap: 18 }}>
          ...
          <label style={{ display: 'grid', gap: 8, color: ui.text, fontWeight: 600, fontSize: 14 }}>
            ...
            <div style={fieldWrap}>
              ...
              <input value={identifier} onChange={(event) => setIdentifier(event.target.value)} style={fieldInput} placeholder="board@eurohouse.vn" />
            </div>
          </label>
